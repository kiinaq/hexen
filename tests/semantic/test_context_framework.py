...
class TestContextFrameworkCoercion:
    ...
    def test_comptime_int_coercion_with_context(self):
        """Test comptime_int coerces correctly with target context"""
        ast = {
            "type": "program",
            "functions": [
                {
                    ...
                    "body": {
                        "type": "block",
                        "statements": [
                            # Different target types for same literal
                            {
                                "type": "val_declaration",
                                "name": "as_i32",
                                "type_annotation": "i32",
    ...
    def test_comptime_float_coercion_with_context(self):
        """Test comptime_float coerces correctly with target context"""
        ast = {
            "type": "program",
            "functions": [
                {
