...
class ArraySemanticError(Exception):
    ...
    def __init__(self, message: str, node: Optional[Dict[str, Any]] = None, suggestion: Optional[str] = None):
...
class ArrayErrorMessages:
    ...
    @staticmethod
    def element_type_incompatible(source_type: str, target_type: str, context: str) -> str:
...
class ArrayErrorFactory:
    ...
    @staticmethod
    def create_size_mismatch_error(expected: int, actual: int, context: str, 
                                   node: Optional[Dict[str, Any]] = None) -> ArraySemanticError:
    ...
    @staticmethod
    def create_bounds_error(index: int, array_size: int, 
                           node: Optional[Dict[str, Any]] = None) -> ArraySemanticError:
    ...
    @staticmethod
    def create_empty_context_error(node: Optional[Dict[str, Any]] = None) -> ArraySemanticError:
    ...
    @staticmethod
    def create_inconsistent_structure_error(row: int, expected_cols: int, actual_cols: int,
                                           node: Optional[Dict[str, Any]] = None) -> ArraySemanticError:
        """Create an inconsistent multidimensional structure error."""
        message = ArrayErrorMessages.inconsistent_multidim_structure(row, expected_cols, actual_cols)
        suggestion = f"Ensure all rows have exactly {expected_cols} elements"
        return ArraySemanticError(message, node, suggestion)
    
    @staticmethod
    def create_invalid_index_type_error(index_type: str, 
                                       node: Optional[Dict[str, Any]] = None) -> ArraySemanticError:
